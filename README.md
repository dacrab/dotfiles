...
| `waybar-stow` | Top bar for Niri (Hyprland's wayle bar config is autogenerated) |
...
# Hyprland desktop
stow hypr-stow vicinae-stow wofi-stow nwg-bar-stow
...
| `wall` | Sets a random wallpaper (Hyprland) |
